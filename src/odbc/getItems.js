...
function getItemsWithOutCountryCodes(orderNumbersArray) {
    ...
    const itemsSql = `
        ...
        SELECT 
            ...
            COALESCE(TRIM(OCRI.DDUNIT), TRIM(OCMI.DDUNIT)) AS QuantityUOM,
            COALESCE(TRIM(OCRI.DDUNPR), TRIM(OCMI.DDUNPR)) AS UnitPrice,
        ...
        LEFT JOIN OCMI ON TRIM(BOLD.FGORD#) = TRIM(OCMI.DDORD#) AND TRIM(BOLD.FGITEM) = TRIM(OCMI.DDITM#)
